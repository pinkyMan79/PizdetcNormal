...
public enum Tile {
	FLOOR((char) 250, new Color(0, 205, 44), "A dirt and rock cave floor."), WALL(
			(char) 177, new Color(0, 205, 44), "A dirt and rock cave wall."), BOUNDS(
			...
			'<', AsciiPanel.white, "A stone staircase t" +
			"hat goes up."), UNKNOWN(
