...
public class StuffFactory {
	...
	public Creature newFungus(int depth) {
		Creature fungus = new Creature(world, 'd', AsciiPanel.red, "deadline",
				10, 0, 0);
	...
	public Creature newBat(int depth) {
		Creature bat = new Creature(world, 'b', AsciiPanel.brightYellow, "bad-project-manager",
				15, 5, 0);
	...
	public Creature newZombie(int depth, Creature player) {
		Creature zombie = new Creature(world, 'z', AsciiPanel.white, "zombie-teammate",
				50, 10, 10);
	...
	public Item newRock(int depth) {
		Item rock = new Item(',', AsciiPanel.yellow, "Book about Pasca", null);
	...
	public Item newDagger(int depth) {
		Item item = new Item(')', AsciiPanel.white, "Zatochennaya Klava", null);
	...
	public Item newSword(int depth) {
		Item item = new Item(')', AsciiPanel.brightWhite, "Mouse on chains", null);
	...
	public Item newStaff(int depth) {
		Item item = new Item(')', AsciiPanel.yellow, "Klava-Shield", null);
		item.modifyAttackValue(5);
	...
	public Item newBow(int depth) {
		Item item = new Item(')', AsciiPanel.yellow, "Resinka", null);
	...
	public Item newLightArmor(int depth) {
		Item item = new Item('[', AsciiPanel.green, "BaltArtek-t-shirt", null);
	...
	public Item newMediumArmor(int depth) {
		Item item = new Item('[', AsciiPanel.white, "Java-t-shirt", null);
	...
	public Item newHeavyArmor(int depth) {
		Item item = new Item('[', AsciiPanel.brightWhite, "Fullstack-shirt", null);
